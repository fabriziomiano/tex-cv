...
\cvsection{Industrial Experience}
  \begin{cventries}
    ...
    {Sep 2020 -- Now}
    {
      \begin{cvitems}
        \item {
          Involvement in an international project focused on the analysis of customer demand and forecast within the Agile framework, by employing Microsoft Azure services such as, Databricks, SQL DB, SQL Data Warehouse, Data Factory, Data Lake, Analysis Services, PowerBI, and guaranteeing clean code with code review tools such as Gerrit, and continuous deployment by employing automation pipelines with Jenkins and Terraform
        }
      \end{cvitems}
    }
