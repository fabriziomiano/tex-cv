...
\cvsection{Industrial Experience}
  \begin{cventries}
    ...
    {
      \begin{cvitems}
        \item {NLP and text mining: development of a deep-learning tool to perform information extraction, and in particular named entities, by employing pattern matching. Trained Conditional Random Field to carry out text annotation}
        \item {Recommendation engine: participated in the development of a job recommendation engine}
      \end{cvitems}
    }
